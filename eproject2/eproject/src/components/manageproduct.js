...
var ManageProduct=()=>
{
    ...
    useEffect(()=>
    {
       if(subcat!=="")
       {
        fetch(`${API_URL}/api/getproductsbysubcatid?scatid=${subcat}`).then(resp=>
        {
            if(resp.ok)
            {
    ...
    useEffect(()=>
    {
       if(cat!=="")
       {
        fetch(`${API_URL}/api/getsubcategory?catid=${cat}`).then(resp=>
        {
            if(resp.ok)
            {
                resp.json().then(result=>
