      ...
      <section className="w3l-forml-main py-5">
        <div className="form-hnyv-sec py-sm-5 py-3">
          <div className="form-wrapv">
            ...
            <label htmlFor="rememberMe" className="fw-bold"><input id="rememberMe" className="ms-2" type="checkbox" onChange={(e)=>setremember(e.target.checked)}/> Remember me</label><br/><br/>
