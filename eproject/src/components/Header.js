        ...
        <div className="container">
            <nav className="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                <h1><Link className="navbar-brand pe-xl-5 pe-lg-4" to="/homepage">
                        <span className="fz-neon">Cemetex</span> <span style={{color:'var(--fz-text)'}}>Tools</span>
                    </Link></h1>
                    ...
                    <ul className="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll align-items-lg-center">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li className="nav-item">
                                    <Link to="/insulated-tools-maintenance" className="nav-link">Insulated Tools Maintenance</Link>
                                </li>
                        <li className="nav-item search-right">
                            <a href="#search" className="btn search-btn" title="search" aria-label="Search"><span className="fas fa-search fz-icon me-2" aria-hidden="true"></span><span className="fz-hide-sm">Search</span></a>
                ...
                <ul className="header-search ms-lg-auto d-flex align-items-center gap-2">
                    ...
                    <li className="shopvcart galssescart2 cart cart box_1 get-btn">
                           ...
                           <button type="button" className="top_shopv_cart position-relative">
                            <span className="fas fa-shopping-bag fz-icon-lg me-lg-2"></span><span className="btn-texe-inf fz-hide-sm">Cart</span>
