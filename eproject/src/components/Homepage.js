    ...
    return(
                ...
                <div className="slider-info banner-view banner-top1">
                    <div className="container">
                        <div className="banner-info header-hero-19">
                            <h5>Pro‑Grade Performance</h5>
                            <h3 className="title-hero-19">Cemetex Tools for Every Trade</h3>
                            <p>Engineered for reliability. Tested for the field. Built to last.</p>
                            <Link to="/showcategory" className="btn btn-style btn-primary mt-sm-5 mt-4">Shop Tools <i className="fas fa-arrow-right ms-lg-3 ms-2"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div>
            <div className="item">
                <div className="slider-info banner-view banner-top2">
                    <div className="container">
                        <div className="banner-info header-hero-19">
                            <h5>Electrical & Insulated</h5>
                            <h3 className="title-hero-19">Work Safer with VDE Tools</h3>
                            <p>Certified up to 1000V. Maintain and test per IEC/EN 60900.</p>
                            <Link to="/insulated-tools-maintenance" className="btn btn-style btn-primary mt-sm-5 mt-4">Maintenance Guide <i className="fas fa-arrow-right ms-lg-3 ms-2"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div className="item">
                        <div className="slider-info banner-view banner-top3">
                            <div className="container">
                                <div className="banner-info header-hero-19">
                                    <h5>Power & Precision</h5>
                                    <h3 className="title-hero-19">Cordless Systems that Deliver</h3>
                                    <p>Max torque, long runtime, compact frames — job after job.</p>
                                    <Link to="/showcategory" className="btn btn-style btn-primary mt-sm-5 mt-4">Explore Categories <i className="fas fa-arrow-right ms-lg-3 ms-2"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <div className="item">
                <div className="slider-info banner-view banner-top4">
                    <div className="container">
                        <div className="banner-info header-hero-19">
                            <h5>Hand Tools</h5>
                            <h3 className="title-hero-19">Durable. Ergonomic. Accurate.</h3>
                            <p>From wrenches to crimpers — tuned for professional use.</p>
                            <Link to="/showcategory" className="btn btn-style btn-primary mt-sm-5 mt-4">Browse Hand Tools <i className="fas fa-arrow-right ms-lg-3 ms-2"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section className="w3l-witemshny-main py-5">
        <div className="container py-md-4">
            ...
            {featuredata.map((data,i)=>
                    ...
                    <a href="#prod" className='badge bg-danger'>₹{data.rate}</a>
                    </Link>
                </div>
            )}
